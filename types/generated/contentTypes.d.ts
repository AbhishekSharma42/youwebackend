...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'YouWe Fashion'>;
    Text: Attribute.Text &
      Attribute.Required &
      Attribute.DefaultTo<'Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quod odit perferendis, nobis officia fugit at non ducimus dolorem voluptates, aliquam molestiae corrupti. Tempore similique impedit hic veniam eveniet natus.'>;
    ContactNum: Attribute.BigInteger & Attribute.Required;
    Email: Attribute.Email &
      Attribute.Required &
      Attribute.DefaultTo<'Youwefashion24x7@gmail.com'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiGalaryGalary extends Schema.CollectionType {
  collectionName: 'galaries';
  info: {
    singularName: 'galary';
    pluralName: 'galaries';
    displayName: 'Galary';
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    ConformOrder: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::galary.galary': ApiGalaryGalary;
